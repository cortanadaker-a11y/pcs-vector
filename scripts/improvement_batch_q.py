"""Warmth loop 5 — E-8 IEP, E-4 job-seeker, O-3 DITY long move."""
...
BATCH_Q = {
    ...
    "e4_stewart_knox_jobseeker": {
        ...
        "concern_flags": ["Pet deposit / breed restrictions", "Tight PCS timeline"],
    },
    "o3_hood_jblm_dity": {
        "first_name": "Lauren",
        "last_name": "Chen",
