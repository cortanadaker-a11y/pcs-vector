...
- For Fort Bragg and Fort Hood, use installation-specific neighborhoods, schools, employers, weather, and commute realities.
...
- If gaining installation is not Fort Bragg or Fort Hood, still produce a strong plan but note that local data is less detailed.
...
def build_user_prompt(form_data: dict[str, Any]) -> str:
    ...
    return (
        ...
        "Make Fort Bragg / Fort Hood guidance highly specific when applicable."
    )