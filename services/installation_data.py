...
INSTALLATION_DATA: dict[str, dict[str, Any]] = {
    ...
    "Fort Belvoir, VA": {
        ...
        "priority": "High",
        "theater": "CONUS",
        "notes": "NCR post; intel, logistics, and agency footprint. DC/NoVA cost of living high; traffic defines housing choice.",
        "major_areas": [
            "Alexandria (south)",
            "Lorton",
            "Woodbridge",
        ...
        "commute_notes": "I-95 and Fairfax County Pkwy choke daily; reverse commute from south often better.",
    },
    "Fort Benning, GA": {
        "state": "GA",
        "priority": "High",
    ...
    "Fort Myer, VA": {
        ...
        "priority": "High",
        "theater": "CONUS",
        "notes": "Joint Base Myer–Henderson Hall. Ceremonial / NCR mission. Arlington housing scarce; many live in Alexandria or DC metro.",
        "major_areas": [
            "Arlington",
            "Alexandria",
            "Falls Church",
        ...
        "commute_notes": "I-395 and GW Parkway peak; Metro access is a major housing filter.",
    },
    "Fort Polk, LA": {
        "state": "LA",
        "priority": "Medium",
